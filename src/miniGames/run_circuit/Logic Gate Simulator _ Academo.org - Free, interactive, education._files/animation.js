...
var ui = {
    newNode: {
        title: "",
        value: "Input",
        values: [["INPUT", "Input"], ["OUTPUT", "Output"], ["NOT", "Not"], ["AND", "And"], ["AND (3 inputs)", "And3"], ["NAND", "Nand"], ["OR", "Or"], ["NOR", "Nor"], ["XOR", "Xor"],]
    }, addNode: {title: "Add node", type: "button"}, fullScreen: {title: "Full screen mode", type: "button"}
};
