!function (t, n) {
    ...
    t.fn.noUiSlider = function (e) {
        function a(n, e, a) {
            t.isArray(n) || (n = [n]), t.each(n, function (t, n) {
        ...
        function o(e) {
            e.preventDefault();
            var a, i, o = 0 === e.type.indexOf("touch"), r = 0 === e.type.indexOf("mouse"),
                s = 0 === e.type.indexOf("pointer"), l = e;
        ...
        function r(n, e, a, i, r) {
            return n = n.replace(/\s/g, x + " ") + x, r ? (r > 1 && (i = t.extend(e, i)), e.on(n, t.proxy(a, i))) : (i.handler = a, e.on(n, t.proxy(function (t) {
        ...
        function d(n, e) {
            ...
            var o = {
                handles: {
                    ...
                    r: !0, t: function (t, n, e) {
                        return 2 !== t.length ? !1 : (t = [parseFloat(t[0]), parseFloat(t[1])], s(t[0]) && s(t[1]) ? "range" === e && t[0] === t[1] ? !1 : t[1] < t[0] ? !1 : (n[e] = t, !0) : !1)
                    }
                }, start: {
                    r: !0, t: function (n, e, a) {
                        return 1 === e.handles ? (t.isArray(n) && (n = n[0]), n = parseFloat(n), e.start = [n], s(n)) : this.parent.range.t(n, e, a)
                    }
                }, connect: {
                    t: function (t, n) {
                    ...
                    r: !0, t: function (n, e) {
                        if (n.resolution) switch (n.resolution) {
                            case 1:
                            case.1:
                            case.01:
                            case.001:
                            ...
                            default:
                                return !1
                        } else e.serialization.resolution = .01;
                        return n.mark ? "." === n.mark || "," === n.mark : (e.serialization.mark = ".", n.to ? 1 === e.handles ? (t.isArray(n.to) || (n.to = [n.to]), e.serialization.to = n.to, a(n.to[0])) : 2 === n.to.length && a(n.to[0]) && a(n.to[1]) : !1)
                    }
                }, slide: {
                    t: function (t) {
            ...
            t.each(r, function (t, a) {
                if (a.r && !n[t] && 0 !== n[t] || (n[t] || 0 === n[t]) && !a.t(n[t], n, t)) throw console && console.log && console.group && (console.group("Invalid noUiSlider initialisation:"), console.log("Option:	", t), console.log("Value:	", n[t]), console.log("Slider:	", e[0]), console.groupEnd()), new RangeError("noUiSlider")
            })
        }
        ...
        function c(t, n) {
            return t = t.toFixed(n.data("decimals")), t.replace(".", n.data("mark"))
        }
        ...
        function f(e, a) {
            var o = e.data("nui").number,
                s = {target: e.data("nui").target, options: e.data("nui").options, handle: e, i: o};
            return i(a.to[o]) ? (r("change blur", a.to[o], O[0], s, 2), r("change", a.to[o], s.options.set, s.target, 1), a.to[o]) : "string" == typeof a.to[o] ? t('<input type="hidden" name="' + a.to[o] + '">').appendTo(e).addClass(C[3]).change(O[1]) : a.to[o] === !1 ? {
                val: function (t) {
        ...
        function p(t) {
            var n = this.base, e = n.data("style"), i = t.x - this.startEvent.x,
                o = "left" === e ? n.width() : n.height();
            "top" === e && (i = t.y - this.startEvent.y), i = this.position + 100 * i / o, h(this.handle, i), a(n.data("options").slide, n.data("target"))
        }

        function g() {
            var n = this.base, e = this.handle;
            e.children().removeClass(C[4]), E.off(P.move), E.off(P.end), t("body").off(x), n.data("target").change(), a(e.data("nui").options.set, n.data("target"))
        }

        function v(n) {
            var e = this.handle, a = e[0].gPct(e.data("nui").style);
            e.children().addClass(C[4]), r(P.move, E, p, {
                startEvent: n,
                position: a,
                base: this.base,
                target: this.target,
        ...
        function b(t) {
            if (!this.base.find("." + C[4]).length) {
                var n, e, i, o = this.base, r = this.handles, s = o.data("style"), l = t["left" === s ? "x" : "y"],
                    d = "left" === s ? o.width() : o.height(),
                    u = {handles: [], base: {left: o.offset().left, top: o.offset().top}};
                for (n = 0; n < r.length; n++) u.handles.push({left: r[n].offset().left, top: r[n].offset().top});
                i = 1 === r.length ? 0 : (u.handles[0][s] + u.handles[1][s]) / 2, e = 1 === r.length || i > l ? r[0] : r[1], o.addClass(C[5]), setTimeout(function () {
                    o.removeClass(C[5])
                }, 300), h(e, 100 * (l - u.base[s]) / d), a([e.data("nui").options.slide, e.data("nui").options.set], o.data("target")), o.data("target").change()
            }
        }
        ...
        function y(n) {
            return this.each(function (e, a) {
                ...
                for (n = t.extend({
                ...
                }, n) || {}, n.serialization || (n.serialization = {
                    to: [!1, !1],
                    resolution: .01,
                    mark: "."
                }), d(n, a), n.S = n.serialization, n.connect ? "lower" === n.connect ? (g.base.push(C[9], C[9] + C[7]), g.origin[0].push(C[12])) : (g.base.push(C[9] + C[8], C[12]), g.origin[0].push(C[9])) : g.base.push(C[12]), o = "vertical" === n.orientation ? "top" : "left", s = n.S.resolution.toString().split("."), s = "1" === s[0] ? 0 : s[1].length, "vertical" === n.orientation ? g.base.push(C[10]) : g.base.push(C[11]), c.addClass(g.base.join(" ")).data("target", a), a.data({
                    base: c,
                    mark: n.S.mark,
                    decimals: s
                }), i = 0; i < n.handles; i++) u = t("<div><div/></div>").appendTo(c), u.addClass(g.origin[i].join(" ")), u.children().addClass(g.handle[i].join(" ")), r(P.start, u.children(), v, {
                    base: c,
                    target: a,
                    handle: u
                }), r(P.end, u.children(), m, {base: c, target: a, handle: u}), u.data("nui", {
                    target: a,
                    decimals: s,
                    options: n,
                    base: c,
                    style: o,
                    number: i
                }).data("store", f(u, n.S)), u[0].gPct = l, p.push(u), h(u, k.to(n.range, n.start[i]));
                c.data({options: n, handles: p, style: o}), a.data({handles: p}), r(P.end, c, b, {
                    base: c,
                    target: a,
                    handles: p
                })
        ...
        function U(e, i) {
            return e === n ? w.call(this) : (i = i === !0 ? {trigger: !0} : i || {}, t.isArray(e) || (e = [e]), this.each(function (o, r) {
                r = t(r), t.each(t(this).data("handles"), function (o, s) {
                    if (null !== e[o] && e[o] !== n) {
                        var l, d, u, f = s.data("nui").options.range, p = e[o];
                        i.trusted = !0, (i.trusted === !1 || 1 === e.length) && (i.trusted = !1), 2 === e.length && t.inArray(null, e) >= 0 && (i.trusted = !1), "string" === t.type(p) && (p = p.replace(",", ".")), p = k.to(f, parseFloat(p)), u = h(s, p, i.trusted), i.trigger && a(s.data("nui").options.set, r), u || (l = s.data("store").val(), d = k.is(f, s[0].gPct(s.data("nui").style)), l !== d && s.data("store").val(c(d, r)))
                    }
                })
            }))
        }

        var x = ".nui", E = t(document),
            P = {start: "mousedown touchstart", move: "mousemove touchmove", end: "mouseup touchend"}, z = t.fn.val,
            ...
            S = {base: [C[0]], origin: [C[1]], handle: [C[2]]}, k = {
                to: function (t, n) {
                    return n = t[0] < 0 ? n + Math.abs(t[0]) : n - t[0], 100 * n / this.len(t)
                }, from: function (t, n) {
...
Colors = {
    colors: ["black", "blue", "red", "purple", "turquoise", "green", "orange", "magenta", "gold", "yellow", "violet", "khaki", "maroon", "beige", "darkorchid", "darkblue", "darkorange", "fuchsia", "aqua", "darkgrey", "darkkhaki", "navy", "darkolivegreen", "darkcyan", "darksalmon", "lightcyan", "lightyellow", "lightgreen", "lightpink", "darkgreen", "silver", "darkviolet", "lightblue", "brown", "darkmagenta", "lime", "indigo", "azure", "lightgrey", "olive", "pink", "cyan", "darkred",],
    colorMaps: {
        aqua: "#00ffff",
        azure: "#f0ffff",
        beige: "#f5f5dc",
...
$(document).ready(function () {
    if ($("#codepen-script").length) {
        ...
        var form = '<div class="interface clearfix"><button id="codepen-submit-button" title="CodePen is a free online tool for editing and writing code." onclick=\'document.getElementById("codepen-form").submit();\'><i class="icon-link-ext"></i> Open with CodePen <i class="fa fa-codepen"></i></button></div>' +
    ...
    var sponsoredLinks = ['<a href="https://clkuk.tradedoubler.com/click?p=259740&a=2877167&g=23011826" target="_BLANK"><img src="' + 'https://impus.tradedoubler.com/imp?type(img)g(23011826)a(2877167)' + new String(Math.random()).substring(2, 11) + '" border=0></a>', '<a href="https://clkuk.tradedoubler.com/click?p=259740&a=2877167&g=22604638" target="_BLANK"><img src="' + 'https://impus.tradedoubler.com/imp?type(img)g(22604638)a(2877167)' + new String(Math.random()).substring(2, 11) + '" border=0></a>', '<a href="https://clkuk.tradedoubler.com/click?p=259740&a=2877167&g=23085442" target="_BLANK"><img src="' + 'https://impus.tradedoubler.com/imp?type(img)g(23085442)a(2877167)' + new String(Math.random()).substring(2, 11) + '" border=0></a>', '<a href="//treehouse.7eer.net/c/318020/243355/3944"><img src="//a.impactradius-go.com/display-ad/3944-243355" border="0" alt="" width="468" height="60"/></a><img height="0" width="0" src="//treehouse.7eer.net/i/318020/243355/3944" style="position:absolute;visibility:hidden;" border="0" />',];
    $(".js-sponsor-wrapper").html(shuffle(sponsoredLinks)[0]);
    var sponsoredTilesInner = ['<a href="https://track.fiverr.com/visit/?bta=106024&nci=6295" Target="_Top"><img border="0" src="https://fiverr.ck-cdn.com/tn/serve/?cid=4418397"  width="300" height="250"></a>', '<a href="https://track.fiverr.com/visit/?bta=106024&nci=6267" Target="_Top"><img border="0" src="https://fiverr.ck-cdn.com/tn/serve/?cid=4418516"  width="300" height="250"></a>', '<a href="https://track.fiverr.com/visit/?bta=106024&nci=6442" Target="_Top"><img border="0" src="https://fiverr.ck-cdn.com/tn/serve/?cid=4418978"  width="300" height="250"></a>', '<a href="https://track.fiverr.com/visit/?bta=106024&nci=7831" Target="_Top"><img border="0" src="https://fiverr.ck-cdn.com/tn/serve/?cid=4419005"  width="300" height="250"></a>', '<a href="https://track.fiverr.com/visit/?bta=106024&nci=7837" Target="_Top"><img border="0" src="https://fiverr.ck-cdn.com/tn/serve/?cid=4419035"  width="300" height="250"></a>', '<a href="https://click.linksynergy.com/fs-bin/click?id=7g1B84Yd9f4&offerid=759505.350&subid=0&type=4"><IMG border="0"   alt="Career skills to jumpstart your future." src="https://ad.linksynergy.com/fs-bin/show?id=7g1B84Yd9f4&bids=759505.350&subid=0&type=4&gridnum=13"></a>', '<a href="https://click.linksynergy.com/fs-bin/click?id=7g1B84Yd9f4&offerid=759505.340&subid=0&type=4"><IMG border="0"   alt="Start your future on Coursera today." src="https://ad.linksynergy.com/fs-bin/show?id=7g1B84Yd9f4